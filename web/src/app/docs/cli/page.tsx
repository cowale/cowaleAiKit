        ...
        <div className="max-w-3xl">
            ...
            <div className="mb-8 pb-8 border-b border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400">
                    Command-line interface for managing Cowale AI Kit installations.
                </p>
            </div>
            ...
            <section className="mb-12">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    The <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">ai-kit</code> CLI tool helps you manage Cowale AI Kit installations across your projects.
                </p>
            </section>
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50 mb-3">
                            <code className="font-mono">ai-kit init</code>
                        </h3>
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Initialize Cowale AI Kit in your project by installing the <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">.agent</code> folder.
                        </p>

                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit init</code>
                            </pre>
                        </div>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50 mb-3">
                            <code className="font-mono">ai-kit update</code>
                        </h3>
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Update your existing Cowale AI Kit installation to the latest version.
                        </p>

                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit update</code>
                            </pre>
                        </div>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50 mb-3">
                            <code className="font-mono">ai-kit status</code>
                        </h3>
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                        ...
                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit status</code>
                            </pre>
                        </div>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit init --force</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit init --path ./my-project</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit init --branch dev</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">ai-kit init --quiet --force</code>
                            </pre>
                        </div>
                    </div>
                </div>
