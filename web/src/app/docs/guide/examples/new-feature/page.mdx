export const metadata = {
  title: "Example: Add a New Feature | Cowale AI Kit",
  description: "Step-by-step guide on adding new features to an existing application using Cowale AI Kit workflows.",
};
