...
export const metadata = {
  title: "Installation | Cowale AI Kit",
  description: "Get started with Cowale AI Kit in under a minute.",
};
    ...
    <div className="max-w-3xl">
      ...
      <div className="mb-8 pb-8 border-b border-zinc-200 dark:border-zinc-800">
        ...
        <p className="text-lg text-zinc-600 dark:text-zinc-400">
          Get started with Cowale AI Kit in under a minute.
        </p>
      </div>
      ...
      <section id="quick-start" className="mb-12 scroll-mt-16">
        ...
        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
          The fastest way to install Cowale AI Kit is using <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">npx</code> in root project:
        </p>
      ...
      <section id="global-install" className="mb-12 scroll-mt-16">
        ...
        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
          Install the CLI globally to use <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">ai-kit</code> command anywhere:
        </p>
...
└── ARCHITECTURE.md  # Full documentation`}
      ...
      <section className="mb-12">
        ...
        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
          Now that you have Cowale AI Kit installed, learn about the core concepts:
        </p>
