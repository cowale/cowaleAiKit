        ...
        <div className="max-w-3xl">
            ...
            <section className="mb-12">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                    ...
                    <a
                        href="https://Cowale AI Kit.google/t"
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                    Whether you're an individual developer or part of a larger team, Cowale AI Kit helps you build better software faster with {skills.length}+ skills, {agents.length}+ specialist agents, and {workflows.length}+ production-ready workflows.
                </p>
            </section>
