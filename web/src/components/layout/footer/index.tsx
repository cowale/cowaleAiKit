            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    Examples
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit/releases" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    Changelog
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit/issues" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    Issues
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit/discussions" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    Discussions
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    Contributing
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a href="https://github.com/cowale/cowaleAiKit/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
                                    License
                                </a>
                            </li>
                            <li>
                ...
                <div className="pt-8 border-t border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        © {new Date().getFullYear()} Cowale AI Kit by{" "}
                        <a
                            href="https://github.com/cowale"
                            target="_blank"
                    ...
                    <div className="flex items-center gap-4">
                        <a
                            href="https://github.com/cowale/cowaleAiKit"
                            target="_blank"
                            rel="noopener noreferrer"
